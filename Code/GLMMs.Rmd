...
The goal of this analysis is to model the relationship between isotope values and impervious surface cover for coyotes in San Francisco that are assigned to family groups.
...
# ggsave("Figures/Figure6a.png", dpi=600, height=4, width=4)
...
fig.6b <- ggplot() +
  ...
  # Graphics
  labs(x = "", y = expression(~delta^{15}~N)) +
  theme_custom() +
  scale_x_continuous(limits=c(15,85), expand = c(0.002, 0)) +
...
# ggsave("Figures/Figure6b.png", dpi=600, height=4, width=4)
```
