...
# Load model output from previously run model
...
discr.coy.ISA <- load_discr_data(filename="Cleaned_Data/coyote_discrimination_three.csv", mix.coy.avgs)
```
...
# ggsave("Figures/Figure6c.png", dpi=600, height=4, width=4)
```
