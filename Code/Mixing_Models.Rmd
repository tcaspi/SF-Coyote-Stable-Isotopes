...
# Create top row with proper alignment
top_row <- plot_grid(fig.4a, fig.4c, 
                     ncol = 2, labels = c("a", "b"), 
                     label_x = 0.135, align = "hv", axis = "tblr")

# Create bottom row (full width)
bottom_row <- plot_grid(fig.4b, ncol = 1, label_x = 0.135)

# Stack top and bottom row
Fig.4 <- plot_grid(top_row, bottom_row, 
                        ncol = 1, rel_heights = c(1, 1.5))

Fig.4

# ggsave("Figures/Figure4.png", dpi=600, height=6, width=8)
```
