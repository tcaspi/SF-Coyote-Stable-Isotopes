...
top_row <- plot_grid(fig.5a, fig.5c, 
                     ncol = 2, labels = c("a", "c"), 
                     label_x = 0.135, align = "hv", axis = "tblr")

# Create bottom row (full width)
bottom_row <- plot_grid(fig.5b, ncol = 1, label_x = 0.135)

# Stack top and bottom row
Fig.5 <- plot_grid(top_row, bottom_row, 
                        ncol = 1, rel_heights = c(1, 1.5))

Fig.5

# ggsave("Figures/Figure5.png", dpi=600, height=6, width=8)
```
