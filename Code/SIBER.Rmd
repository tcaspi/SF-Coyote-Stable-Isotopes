...
fig.3e <- ggplot(SEA.B.pops, aes(x = Site, y = Value, fill = Site, color=Site)) +
    ...
    labs(y = "Bayesian Standard Ellipse Area", x = "Site") +
    scale_fill_manual(values = c("San Francisco" = "#C0362D", "Marin County" = "#284A45")) +
    scale_color_manual(values = c("San Francisco" = "#C0362D", "Marin County" = "#284A45")) +
