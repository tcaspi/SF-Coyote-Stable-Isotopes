...
colors <- c("#C8BFE7", "#2E2585", "#7E2954", "blue", "#DCCD7D", "#C26A77", "#FDB462FF", "#5DA899", "#337538", "pink")
...
fig.S2 <- data_clean %>% 
  ...
  scale_color_manual(values=c("#284A45", "#c0362d"))+
...
# ggsave("Figures/Figure2.png",dpi=600, width=8, height=3)

# Plot all SF individuals, highlighting repeatedly sampled individuals
fig.S1 <- data_average_sf %>% 
  ggplot(aes(x = C_avg, y = N_avg)) +
...
# ggsave("Figures/FigureS1.png",dpi=600, width=4, height=3)
```
