...
fig2a <- data_average %>% 
  ...
  scale_color_manual(values=c("#9292B1", "#c0362d"), labels=c("Nonurban", "Urban"))+
  xlab(expression({delta}^13*C))+
  ylab(expression({delta}^15*N))+
...
# ggsave("Figures/Figure2b.png",dpi=600, width=3.4, height=2.8)
...
ggarrange(
 ...
 ggsave("Figures/Figure2.png",dpi=600, width=4, height=6.5)
